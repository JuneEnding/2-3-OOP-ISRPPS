    ...
    public class ControllerEditor
    {
        ...
        public void Paint(Graphics gr)
        {
            ...
            for (int count = 0; count < model.countel; count++)
            {
                ...
                Pen elpen1 = new Pen(ColorFromName(el.color), bold);
                Pen elpen3 = new Pen(ColorFromName(el.color), 3 * bold);
                SolidBrush elBrush = new SolidBrush(ColorFromName(el.color));
                ...
                for (int numrel = 0; numrel < model.countel; numrel++)
                {
                    ...
                    if (rel != null)
                        if (rel.direction > 0)
                        {
                            ...
                            Pen curpen = new Pen(ColorFromName(el.color), bold);
